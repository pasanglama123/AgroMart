...
import passlogo from '../../assets/icons/password.svg'
import { Link } from 'react-router-dom';

const Login = () => {
  return (
    <div className="w-screen h-screen bg-[#E5E5E5] flex justify-center items-center overflow-hidden">
      <div className="w-full h-full bg-white p-6 flex flex-col justify-center max-w-screen-md  md:items-center md:py-10 md:w-[50%] shadow-md ">
